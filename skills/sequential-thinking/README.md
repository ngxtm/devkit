...
Structured, reflective problem-solving methodology designed as a native Agent Skill for deep analytical reasoning.

## Overview

This skill teaches the agent to apply systematic sequential thinking methodology for complex problem-solving. It enables:
...
- Provides a rigid **methodology** to think sequentially
- Pure instructional approach with optional deterministic script validation
...
- Inspired by high-fidelity analytical reasoning patterns.
