...
**Usage:**
```bash
python3 ~/.{TOOL}/skills/senior-frontend/scripts/component_generator.py <project-path> [options]
```
...
**Usage:**
```bash
python3 ~/.{TOOL}/skills/senior-frontend/scripts/bundle_analyzer.py <target-path> [--verbose]
```
