...
```bash
# Core Tool 1
python3 ~/.{TOOL}/skills/senior-data-engineer/scripts/pipeline_orchestrator.py --input data/ --output results/

# Core Tool 2  
python3 ~/.{TOOL}/skills/senior-data-engineer/scripts/data_quality_validator.py --target project/ --analyze

# Core Tool 3
python3 ~/.{TOOL}/skills/senior-data-engineer/scripts/etl_performance_optimizer.py --config config.yaml --deploy
```
...
# Training
python3 ~/.{TOOL}/skills/senior-data-engineer/scripts/train.py --config prod.yaml
python3 ~/.{TOOL}/skills/senior-data-engineer/scripts/evaluate.py --model best.pth
...
python3 ~/.{TOOL}/skills/senior-data-engineer/scripts/health_check.py
```
