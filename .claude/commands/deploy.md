...
- Read `skills-compact.json` → find deployment/infrastructure domain skills (by `k` field)
- Use cascade connections (`e`/`p` fields) to find related deployment skills
- Follow cascade protocol from `auto-skill.md` for weight-aware loading
- Max 3 additional skills, max 5 total loaded
